...
<script type="text/javascript" id="hexo.configurations">
  ...
  <link rel="canonical" href="http://chapter007.github.io/blog/2018-01-24-2017-09-27-(Leetcode)NumberComplement.md"/>
...
<nav class="site-nav">
  ...
  <div class="post-block">
    <link itemprop="mainEntityOfPage" href="http://chapter007.github.io/blog/blog/2018-01-24-2017-09-27-(Leetcode)NumberComplement.md">
    ...
    <span hidden itemprop="publisher" itemscope itemtype="http://schema.org/Organization">
      ...
      <header class="post-header">
          ...
          <h1 class="post-title" itemprop="name headline">(Leetcode)Number Complement解题记录</h1>
    ...
    <footer class="post-footer">
        ...
        <div class="post-nav">
          <div class="post-nav-next post-nav-item">
              ...
              <a href="/blog/2018-01-24-2017-09-26-(Leetcode)ReverseBits.md" rel="next" title="(Leetcode)ReverseBits解题记录">
                <i class="fa fa-chevron-left"></i> (Leetcode)ReverseBits解题记录
              </a>
          ...
          <div class="post-nav-prev post-nav-item">
              ...
              <a href="/blog/2018-01-24-2017-09-28-学习javaweb之spring.md" rel="prev" title="学习java-web之spring">
                学习java-web之spring <i class="fa fa-chevron-right"></i>
              </a>
      ...
      <!--noindex-->
        <section class="post-toc-wrap motion-element sidebar-panel sidebar-panel-active">
          <div class="post-toc">
              ...
              <div class="post-toc-content"><ol class="nav"><li class="nav-item nav-level-2"><a class="nav-link" href="#Leetcode-Number-Complement解题记录"><span class="nav-number">1.</span> <span class="nav-text">(Leetcode)Number Complement解题记录</span></a></li></ol></li><li class="nav-item nav-level-1"><a class="nav-link" href="#题目"><span class="nav-number"></span> <span class="nav-text">题目</span></a></li><li class="nav-item nav-level-1"><a class="nav-link" href="#解题思路"><span class="nav-number"></span> <span class="nav-text">解题思路</span></a></li><li class="nav-item nav-level-1"><a class="nav-link" href="#算法"><span class="nav-number"></span> <span class="nav-text">算法</span></a></li><li class="nav-item nav-level-1"><a class="nav-link" href="#改进"><span class="nav-number"></span> <span class="nav-text">改进</span></a></div>
